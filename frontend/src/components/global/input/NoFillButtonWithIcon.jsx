function NoFillButtonWithIcon({ label = "Button", borderColor = "blue", svgIcon = null }) {
  ...
  return (
    <div className={borderColorDict[borderColor] + "flex justify-center items-center gap-1 border-2 hover:cursor-pointer py-2 px-3 rounded-md text-sm text-center"}>
      {svgIcon &&
        <div>
